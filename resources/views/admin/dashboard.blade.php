                    ...
                    <table class="w-full">
                        <thead class="bg-gray-100 text-gray-700 uppercase text-xs tracking-wider">
                            <tr>
                                ...
                                <th class="px-3 rounded-r-xl">Bayar</th>
                            </tr>
                        </thead>
                            ...
                            <tr class="hover:bg-red-50/50 transition-colors group">
                                ...
                                <td class="px-4 py-5">
                                    <form action="{{ route('admin.order.update', $order->id) }}" method="POST">
                                        ...
                                        <select
                                            ...
                                            <option value="done_payment"
                                                {{ $order->status == 'done_payment' ? 'selected' : '' }}>
                                                💳 Done Payment
                                            </option>
                                ...
                                <td>
                                    <a href="{{ route('order.payment', $order->id) }}"
                                        class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded ml-5">
                                        Bayar
                                    </a>
                                    </a>
                                </td>
